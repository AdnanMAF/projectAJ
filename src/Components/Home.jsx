...
function Home() {
  return (
    <div className="relative h-fit 2xl:h-fit bg-slate-100">
      <img
      ...
      <img
        className="bg-cover bg-center h-screen lg:max-h-s sm:h-auto sm:bg-none hidden sm:block object-center"
        src={TOF}
        alt="Background foto"
      />
      ...
      <div className="absolute inset-0 hidden items-center justify-center my-auto lg:flex">
        <div className="text-center bg-transparent">
          <h1 className="text-4xl shadow shadow-white font-extrabold text-black sm:text-5xl md:text-6xl">
            To-Do List
          </h1>
          <p className="">Make Your Plans More Organized With To-Do List</p>
          <div className="mt-4">
            <div>
  ...
  <div className="text-center bg-transparent">
    <h1 className="text-4xl drop-shadow-2xl font-extrabold text-black sm:text-5xl md:text-6xl">
      To-Do List
    </h1>
